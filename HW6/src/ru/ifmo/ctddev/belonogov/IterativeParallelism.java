...
//            System.out.println("x: " + x);
    ...
    <T, R> R parallel(int threads, final List<? extends T> list, final Function<T, R> action, final Function<List<R>, R> combiner) {
        int len = list.size();
        ...
        ArrayList<R> threadsResult = new ArrayList<>();
        for (int i = 0; i < threads; i++)
